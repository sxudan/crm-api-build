...
CREATE TABLE "Application" (
    ...
    "referer" TEXT,
    "subAgentId" INTEGER,
    "appliedViaId" INTEGER,
    "converted" BOOLEAN NOT NULL DEFAULT false,
    "maritalStatus" "MaritalStatus",
    "spouseFullName" TEXT,
    "spouseDob" TIMESTAMP(3),
    "spouseHighestEducationLevel" TEXT,
    "accompanying" BOOLEAN,
    "previousHighestEducationLevel" TEXT,
    "previousCourseName" TEXT,
    "previousYearOfGraduation" INTEGER,
    "previousOverallScore" TEXT,
    "previousLanguageTestType" TEXT,
    "previousLanguageOtherTestType" TEXT,
    "previousLanguageScore" TEXT,
    "emergencyContactName" TEXT,
...
-- AddForeignKey
ALTER TABLE "Application" ADD CONSTRAINT "Application_appliedViaId_fkey" FOREIGN KEY ("appliedViaId") REFERENCES "SubAgent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
